            ...
            <div class="flex flex-col border shadow-sm bg-primary rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
              ...
              <div class="p-0 mx-auto md:p-7 md:h-96">
                ...
                <div class="relative py-1 ps-12">
                  ...
                  <span class="relative z-10 w-full text-lg font-bold text-white">Seat : <?php echo $row["seat"] ?> Seat</span>
                </div>

                <div class="w-full text-lg font-bold text-center text-white">Car Only</div>
                ...
                <div class="w-full text-lg font-bold text-center text-white">Car + Driver</div>
                <div class="relative py-1 text-center">
                  <div class="absolute inset-0 bg-input opacity-20"></div>
                  <span class="relative z-10 w-full text-lg font-bold text-white">Rp. <?php echo $row["car_only_driver"] ?>,00 - Full Day</span>
                </div>

                <div class="w-full text-lg font-bold text-center text-white">Car + Driver + Fuel</div>
                <div class="relative py-1 text-center">
                  <div class="absolute inset-0 bg-input opacity-20"></div>
                  <span class="relative z-10 w-full text-lg font-bold text-white">Rp. <?php echo $row["car_only_driver_fuel"] ?>,00 - Full Day</span>
                </div>

                <div class="flex justify-center w-full p-4">
                  <button class="px-6 py-1 font-bold text-white rounded-full bg-btncol bookBtn" data-id="<?= $row['id'] ?>" data-gambar="<?= htmlspecialchars($row['gambar']) ?>">
                    Book Now
                  </button>
                </div>
              </div>
